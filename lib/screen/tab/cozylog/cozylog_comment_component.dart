                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                widget.cozyLog.writer.nickname ==
                                        widget.comment.writerNickname
                                    ? Container(
                                        width: AppUtils.scaleSize(context, 46),
                                        height: AppUtils.scaleSize(context, 19),
                                        margin: EdgeInsets.only(
                                            left:
                                                AppUtils.scaleSize(context, 7)),
                                ...
                                builder: (BuildContext context) {
                                  return SizedBox(
                                    height: isMyComment
                                        ...
                                        : AppUtils.scaleSize(context, 234 - 64),
                                    child: Column(
                                      children: [
                                        Container(
                                          padding: isMyComment
                                          ...
                                          height: isMyComment
                                              ? AppUtils.scaleSize(context, 128)
                                              : AppUtils.scaleSize(context, 64),
                                          decoration: BoxDecoration(
                                            borderRadius:
                                                BorderRadius.circular(20),
                                            color: Colors.white,
