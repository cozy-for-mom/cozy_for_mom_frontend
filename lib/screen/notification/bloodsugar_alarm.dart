...
class BloodsugarAlarm extends StatefulWidget {
  const BloodsugarAlarm({super.key});

  @override
  State<BloodsugarAlarm> createState() => _BloodsugarAlarmState();
}

class _BloodsugarAlarmState extends State<BloodsugarAlarm> {
